...
from crawler.items import LawItemKHCN
import re
import time
import copy
...
class crawlerSpider(Spider):
    ...
    def start_requests(self):
        ...
        num = file_index
        file_path = f"D:\\py\\Lab\\Basic_Crawlers-master\\Basic_Crawlers-master\\co_bao\\href_khcn\\href_khcn_{num}.json"
        ...
        for item in data:
            ...
            yield scrapy.Request(url=href, callback=self.parse, meta={'title': title, 'href': href})
            # break
    ...
    def parse(self, response):
        ...
        td_tags = first_table.find_all('td')
        code = ""
        # In nội dung (text) của từng thẻ <td>
        for td in td_tags:
